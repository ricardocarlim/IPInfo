...
Always follow the standards and frameworks used.
...
To run the project, simply open it with Visual Studio and run it. Keep in mind that the logo is always saved as base64 in a text field in the database to avoid increasing its size. This decision is due to the lack of a blob storage service that provides us with a URL for image uploads. Always respect the standards and couplings of the structure.
